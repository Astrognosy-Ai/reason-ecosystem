...
def main():
    ...
    parser.add_argument(
        ...
        help="Use the warf Xchange broker (warf.astrognosy.com) for deposits/arbitration "
             "with resolution through Xport at reason.astrognosy.com. "
    ...
    p_xarb = sub.add_parser("xchange-arbitrate", help="Submit packages for Xchange arbitration through the public broker")
...
• Easy bridge to the public broker: set REASON_USE_XCHANGE=1 or use --xchange; supply a reason:// URI so high-signal artifacts can participate in network workflows
...
This is the production-grade on-ramp to the reason:// stack. Local-first, ecosystem-native, and practical.
