...
class WARFMCPServer:
    ...
    def _register_tools(self):
        ...
        def remember(name: str, arguments: dict) -> ToolResponse:
            ...
            If the client is in Xchange mode, this also routes through the broker.
            """
            try:
                ...
                # Agents using tools automatically feed harness metrics.
        ...
        def recall(name: str, arguments: dict) -> ToolResponse:
            ...
            try:
                ...
                # Record savings using the public helper.
                try:
                    import rdn as reason
        ...
        def xchange_share(name: str, arguments: dict) -> ToolResponse:
            """Share high-value work to the warf Xchange."""
            try:
                content = arguments.get("content", "")
                uri = arguments.get("uri")
        ...
        self.server.add_tool(
            Tool(
                name="xchange_share",
                description="Share a high-signal artifact to the central warf Xchange. Use for reusable solutions, decisions, and patterns.",
                inputSchema={
                    "type": "object",
                    "properties": {
        ...
        self.server.add_tool(
            Tool(
                name="harness_status",
                description="Get the current harness metrics (token savings, velocity, ship rate, positive signals, suggestions) and stack status. Agents can use this to self-assess impact and get workflow ideas.",
                inputSchema={
                    "type": "object",
                    "properties": {},
                },
