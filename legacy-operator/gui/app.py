...
# Add parent directory to path to import rdn modules
...
class ReasonRDNApp(ctk.CTk):
    ...
    def add_handoff_card(self, data):
        ...
        meta = data.get('meta', {})
        integrity_hash = meta.get('structural_hash', meta.get('audit_hash', 'UNKNOWN'))
...
if __name__ == "__main__":
    if "--serve-node" in sys.argv:
        ...
        node_main(sys.argv[sys.argv.index("--serve-node") + 1 :])
    else:
        app = ReasonRDNApp()
        app.mainloop()
